...
const ProductPages = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [brand]); // Đảm bảo rằng hook useEffect chạy lại khi `brand` thay đổi
    ...
    const filteredProducts = infoBrand.filter(product => !brand || product.brand === brand);
    ...
    const renderProducts = () => {
        ...
        } else if (noProducts || filteredProducts.length === 0) {
            return (
